                ...
                const int16_t  * restrict x, int N)
{
    ...
    ae_int32x2 X0,X1,Y0,Y1,_0x80000000;
    ae_f32x2   f0,f1;
    ...
    for (n=0; n<(N&~3); n+=4)
    {
        ...
        X0=AE_ABS32(X0);
        X1=AE_ABS32(X1);
        big0=AE_LT32(_0x80000000,X0);
        big1=AE_LT32(_0x80000000,X1);
        X0=AE_SUB32S(_0x80000000,AE_ABS32(AE_SUB32(X0,_0x80000000)));
        X1=AE_SUB32S(_0x80000000,AE_ABS32(AE_SUB32(X1,_0x80000000)));
        X0 = AE_SAT24S(X0);
        X1 = AE_SAT24S(X1);
        /* compute polynomial */
        ae_int16x4 tmp1 = AE_TRUNCI16X4F32S(X1,X0,8);
        ...
        f0=AE_SUB32(_0x80000000,AE_SRAI32(AE_CVT32X2F16_10(X20_16ae),8));
        f1=AE_SUB32(_0x80000000,AE_SRAI32(AE_CVT32X2F16_32(X20_16ae),8));
        AE_MULAFP32X16X2RAS_L(f0,Y0,X20_16ae);Y0=f0;
        AE_MULAFP32X16X2RAS_H(f1,Y1,X20_16ae);Y1=f1;

...
void vec_antilogn_16x16 (int16_t * restrict y, const int16_t * restrict x, int N)
{
    ...
    ae_int32x2 X0,X1,E0,E1,Y0,Y1,X20,X21;
    ae_f32x2 f0,f1;
	...
	X0 = AE_MULFP32X16X2RAS_L(6051102, x0);
        X1 = AE_MULFP32X16X2RAS_H(6051102, x0);
	...
	X20 = AE_SLAI32(X0, 8);
	X21 = AE_SLAI32(X1, 8);
        ae_int16x4 tmp1 = AE_SEL16_7531(AE_MOVINT16X4_FROMINT32X2(X21),AE_MOVINT16X4_FROMINT32X2(X20));
	AE_MULAFP32X16X2RAS_L(f0, Y0, tmp1);  Y0=f0;
	AE_MULAFP32X16X2RAS_H(f1, Y1, tmp1);  Y1=f1;	

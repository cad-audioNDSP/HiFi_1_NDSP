...
float32_t scl_lognf( float32_t x )
{
  ...
  */
  ...
  XT_MSUBN_SX2( cf1, cf0, fr0 );
  XT_MSUBN_SX2( cf3, cf2, fr0 );
  XT_MSUBN_SX2( cf5, cf4, fr0 );
  XT_MSUBN_SX2( cf7, cf6, fr0 );

                              g = cf1;
  XT_MADDN_SX2( cf3, g, fr1 ); g = cf3;
  XT_MADDN_SX2( cf5, g, fr1 ); g = cf5;
  XT_MADDN_SX2( cf7, g, fr1 ); g = cf7;
  XT_MADDN_SX2( fr0, g, fr1 ); g = fr0;

  XT_MADDN_SX2( g, XT_FLOAT_SX2( ex0, 0 ), ln2.f );
  y0 = g;

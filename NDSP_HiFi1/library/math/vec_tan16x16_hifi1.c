...
void vec_tan16x16 (int16_t* restrict y, const int16_t *restrict x, int N)
{
    ...
    while(M>3)
    {
        ...
        for (n=0; n<N; n+=4)
        {
            ...
            f0=X0;
            f1=X1;
            AE_MULAFP32X16X2RAS_L(f0,Y0,tmp1);Y0=AE_SAT24S(f0);
            AE_MULAFP32X16X2RAS_H(f1,Y1,tmp1);Y1=AE_SAT24S(f1);
            Y0=AE_MAX32(Y0,1);
            Y1=AE_MAX32(Y1,1);
        ...
        for (n=0; n<N; n+=4)
        {
            ...
            ae_int16x4 tmp1 = AE_TRUNCI16X4F32S(Z1,Z0,8);
            f0=f1=AE_L32_I(ptan,28);
            AE_MULSFP32X16X2RAS_L(f0,X0,tmp1);E0=f0;
            AE_MULSFP32X16X2RAS_H(f1,X1,tmp1);E1=f1;
            E0=AE_SLAI32(E0,1);
            E1=AE_SLAI32(E1,1);
            f0=Z0;
            f1=Z1;
            AE_MULAFP32X16X2RAS_L(f0,E0,tmp1);Z0=f0; 
            AE_MULAFP32X16X2RAS_H(f1,E1,tmp1);Z1=f1; 

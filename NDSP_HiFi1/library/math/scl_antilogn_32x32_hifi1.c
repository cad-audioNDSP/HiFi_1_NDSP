...
int32_t scl_antilogn_32x32 (int32_t x) 
{
    ...
    t=AE_L32_I((const ae_int32 *)pow2poly,4*1); AE_MULAFP32X2RAS_L(t,X,Y); Y=t;
    t=AE_L32_I((const ae_int32 *)pow2poly,4*2); AE_MULAFP32X2RAS_L(t,X,Y); Y=t;
    t=AE_L32_I((const ae_int32 *)pow2poly,4*3); AE_MULAFP32X2RAS_L(t,X,Y); Y=t;
    t=AE_L32_I((const ae_int32 *)pow2poly,4*4); AE_MULAFP32X2RAS_L(t,X,Y); Y=t;

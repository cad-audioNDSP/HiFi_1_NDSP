...
{
    ae_int16x4 X,Z;
    ae_f32x2 C0,C1,C2,C3,C4,C5,C6,C7,C8,S0,S1;
    ae_f32x2 t0,t1;
    ...
    NASSERT(z);
    if(N<=0) return;
    C0=AE_L16M_I((const ae_p16s*)c,0*sizeof(int16_t));
    C1=AE_L16M_I((const ae_p16s*)c,1*sizeof(int16_t));
    C2=AE_L16M_I((const ae_p16s*)c,2*sizeof(int16_t));
    C3=AE_L16M_I((const ae_p16s*)c,3*sizeof(int16_t));
    C4=AE_L16M_I((const ae_p16s*)c,4*sizeof(int16_t));
    C5=AE_L16M_I((const ae_p16s*)c,5*sizeof(int16_t));
    C6=AE_L16M_I((const ae_p16s*)c,6*sizeof(int16_t));
    C7=AE_L16M_I((const ae_p16s*)c,7*sizeof(int16_t));
    C8=AE_L16M_X((const ae_p16s*)c,8*sizeof(int16_t));
    ...
    {
        S0=C8; S1=C8;
        t0=C7;AE_MULAFP32X16X2RAS_L(t0, S0, X); S0=(t0);
        t1=C7;AE_MULAFP32X16X2RAS_H(t1, S1, X); S1=(t1);
        t0=C6;AE_MULAFP32X16X2RAS_L(t0, S0, X); S0=(t0);
        t1=C6;AE_MULAFP32X16X2RAS_H(t1, S1, X); S1=(t1);
        t0=C5;AE_MULAFP32X16X2RAS_L(t0, S0, X); S0=(t0); 
        t1=C5;AE_MULAFP32X16X2RAS_H(t1, S1, X); S1=(t1);
        t0=C4;AE_MULAFP32X16X2RAS_L(t0, S0, X); S0=(t0);
        t1=C4;AE_MULAFP32X16X2RAS_H(t1, S1, X); S1=(t1);
        t0=C3;AE_MULAFP32X16X2RAS_L(t0, S0, X); S0=(t0);
        t1=C3;AE_MULAFP32X16X2RAS_H(t1, S1, X); S1=(t1);
        t0=C2;AE_MULAFP32X16X2RAS_L(t0, S0, X); S0=(t0);
        t1=C2;AE_MULAFP32X16X2RAS_H(t1, S1, X); S1=(t1);
        t0=C1;AE_MULAFP32X16X2RAS_L(t0, S0, X); S0=(t0);
        t1=C1;AE_MULAFP32X16X2RAS_H(t1, S1, X); S1=(t1);
        t0=C0;AE_MULAFP32X16X2RAS_L(t0, S0, X);
        t1=C0;AE_MULAFP32X16X2RAS_H(t1, S1, X); 
        t0=AE_SLAA32S(t0,lsh);
        t1=AE_SLAA32S(t1,lsh);

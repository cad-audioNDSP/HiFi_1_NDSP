...
void vec_poly4_16x16 (int16_t * restrict z, const int16_t * restrict x, const int16_t * restrict c, int lsh, int N )
{
    ...
    for (n=0; n<(N&~3); n+=4)
    {
        ...
        S0=C4;
        S1=C4;
        t0=C3;AE_MULAFP32X16X2RAS_L(t0, S0, X); S0=AE_SAT24S(t0);
        t1=C3;AE_MULAFP32X16X2RAS_H(t1, S1, X); S1=AE_SAT24S(t1);
        t0=C2;AE_MULAFP32X16X2RAS_L(t0, S0, X); S0=AE_SAT24S(t0);
        t1=C2;AE_MULAFP32X16X2RAS_H(t1, S1, X); S1=AE_SAT24S(t1);
        t0=C1;AE_MULAFP32X16X2RAS_L(t0, S0, X); S0=AE_SAT24S(t0);
        t1=C1;AE_MULAFP32X16X2RAS_H(t1, S1, X); S1=AE_SAT24S(t1);

  ...
  */
  ...
  for (blkIx = 0; blkIx<blkNum; blkIx++)
  {
   ...
   // __Pragma("no_reorder");
    ...
    tmp_S_rd0=(ae_int16x4*)(scr);
    S_wr0 = (ae_int16x4*)(scr+4*3);
    px = (const ae_int16x4      *)(x - 9);
    for (l = 0; l<(blkLen); l++)
    {

      ae_int16x4 t0, t1, t2,rt0,rt1,rt2;
      ae_int32x2 tt0, tt1;
      ae_int32x2 d0, d1, d2, d3;

      AE_L16X4_IP(t0, tmp_S_rd0, 4 * 2);
      AE_L16X4_IP(t1, tmp_S_rd0, 4 * 2);
      AE_L16X4_IP(t2, tmp_S_rd0, 16 * 2);
      ...
      A0r=AE_MULZASD32X16_H3_L2(d1, t0);
      A0i=AE_MULZAAD32X16_H2_L3(d1, t0);
      A1r=AE_MULZASD32X16_H3_L2(d0, t0);
      A1i=AE_MULZAAD32X16_H2_L3(d0, t0);


      AE_MULSAD32X16_H1_L0(A0r, d2, t0);
      rt0 = AE_SHORTSWAP(t0);
      AE_MULSSD32X16_H3_L2(A0i, d2, rt0);
      AE_MULSAD32X16_H1_L0(A1r, d2, t1);
      rt1 = AE_SHORTSWAP(t1);
      AE_MULSSD32X16_H3_L2(A1i, d2, rt1);


      AE_MULASD32X16_H3_L2(A0r, d3, t1);
      AE_MULASD32X16_H3_L2(A1r, d3, t2);
      rt1 = AE_SHORTSWAP(t1);
      AE_MULAAD32X16_H1_L0(A0i, d3, rt1);
      rt2 = AE_SHORTSWAP(t2);
      AE_MULAAD32X16_H1_L0(A1i, d3, rt2);

      A1r=AE_SLAI64(A1r,9);
      A1i=AE_SLAI64(A1i,9);

      tt0 = AE_TRUNCA32X2F64S(A0r, A0i, 33-8);
      tt1 = AE_ROUND32X2F48SASYM(A1r, A1i);
      z0 = AE_ROUND16X4F32SASYM(tt0, tt1);
    ...
    for (l = 0; l<(blkLen); l++)
    {
      ...
      AE_L16X4_IP(t0, tmp_S_rd0, 4 * 2);
      AE_L16X4_IP(t1, tmp_S_rd0, 4 * 2);
      AE_L16X4_IP(t2, tmp_S_rd0, 4* 4 * 2);

      A2r=AE_MULZASD32X16_H1_L0(d0, t0);
      A2i=AE_MULZAAD32X16_H0_L1(d0, t0);
      B1r=AE_MULZASD32X16_H3_L2(d0, t1);
      B1i=AE_MULZAAD32X16_H2_L3(d0, t1);

      AE_MULSAD32X16_H1_L0(A2r, d1, t1);
      rt1 = AE_SHORTSWAP(t1);
      AE_MULSSD32X16_H3_L2(A2i, d1, rt1);
      AE_MULSAD32X16_H3_L2(B1r, d1, t2);
      rt2 = AE_SHORTSWAP(t2);
      AE_MULSSD32X16_H1_L0(B1i, d1, rt2);

      AE_MULASD32X16_H1_L0(A2r, d3, t2);
      AE_MULASD32X16_H1_L0(B1r, d2, t2);
      AE_MULAAD32X16_H3_L2(A2i, d3, rt2);
      AE_MULAAD32X16_H3_L2(B1i, d2, rt2);
      ...
      tt2 = AE_ROUND32X2F48SASYM(A2r, A2i);
      tt3 = AE_ROUND32X2F48SASYM(B1r, B1i);

      z1 = AE_ROUND16X4F32SASYM(tt2, tt3);

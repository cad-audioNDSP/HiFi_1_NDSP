...
void q2rot_16x16(int16_t   *r, const int16_t   *q, int L)
{
  ...
  for (l = 0; l<(L>>1); l++)
  {
    ae_int64 tmp_q0, tmp_q1;
    ae_int32x2 tmp32;
    r1 = r0;
    /*AE_MULSP24X2(r1, p3, p3);*/ // x0*x0 - x3*x3
    tmp_q0 = AE_MUL32_LL(p3, p3);
    tmp_q1 = AE_MUL32_HH(p3, p3);
    tmp32 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16I(AE_MOVINT16X4_FROMINT64(tmp_q1), AE_MOVINT16X4_FROMINT64(tmp_q0), 3));
    r1 = AE_SUB32(r1,  tmp32) ;

    /*r2 = AE_MULP24X2(p1, p1);*/ // x1*x1
    tmp_q0 = AE_MUL32_LL(p1, p1);
    tmp_q1 = AE_MUL32_HH(p1, p1);
    r2 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16I(AE_MOVINT16X4_FROMINT64(tmp_q1), AE_MOVINT16X4_FROMINT64(tmp_q0), 3));

    /*AE_MULSP24X2(r2, p2, p2); */ // x1*x1 - x2*x2
    tmp_q0 = AE_MUL32_LL(p2, p2);
    tmp_q1 = AE_MUL32_HH(p2, p2);
    tmp32 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16I(AE_MOVINT16X4_FROMINT64(tmp_q1), AE_MOVINT16X4_FROMINT64(tmp_q0), 3));
    r2 = AE_SUB32(r2,  tmp32) ;
    ...
    tmp_q1 = AE_MUL32_HH(p3, p3);
    tmp32 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16I(AE_MOVINT16X4_FROMINT64(tmp_q1), AE_MOVINT16X4_FROMINT64(tmp_q0), 3));
    r0 = AE_ADD32(r0,  tmp32) ;

    B2 = r0; //r[8]
    p02 = AE_ADD24S(p0, p0);
    p12 = AE_ADD24S(p1, p1);
    /*r0 = AE_MULP24X2(p12, p2);*/ // 2*x1*x2
    tmp_q0 = AE_MUL32_LL(p12, p2);
    tmp_q1 = AE_MUL32_HH(p12, p2);
    r0 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16I(AE_MOVINT16X4_FROMINT64(tmp_q1), AE_MOVINT16X4_FROMINT64(tmp_q0), 3));

    B3 = r0; B4 = r0;
    /*AE_MULAP24X2(B3, p02, p3); *///r[1]
    tmp_q0 = AE_MUL32_LL(p02, p3);
    tmp_q1 = AE_MUL32_HH(p02, p3);
    tmp32 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16I(AE_MOVINT16X4_FROMINT64(tmp_q1), AE_MOVINT16X4_FROMINT64(tmp_q0), 3));
    B3 = AE_ADD32(B3,  tmp32) ;

    /*AE_MULSP24X2(B4, p02, p3);*/ //r[3]
    tmp_q0 = AE_MUL32_LL(p02, p3);
    tmp_q1 = AE_MUL32_HH(p02, p3);
    tmp32 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16I(AE_MOVINT16X4_FROMINT64(tmp_q1), AE_MOVINT16X4_FROMINT64(tmp_q0), 3));
    B4 = AE_SUB32(B4,  tmp32) ;

    /*r1 = AE_MULP24X2(p12, p3);*/ // 2*x1*x3
    tmp_q0 = AE_MUL32_LL(p12, p3);
    tmp_q1 = AE_MUL32_HH(p12, p3);
    r1 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16I(AE_MOVINT16X4_FROMINT64(tmp_q1), AE_MOVINT16X4_FROMINT64(tmp_q0), 3));

    B5 = r1; B6 = r1;
    /*AE_MULSP24X2(B5, p02, p2); *///r[2]
    tmp_q0 = AE_MUL32_LL(p02, p2);
    tmp_q1 = AE_MUL32_HH(p02, p2);
    tmp32 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16I(AE_MOVINT16X4_FROMINT64(tmp_q1), AE_MOVINT16X4_FROMINT64(tmp_q0), 3));
    B5 = AE_SUB32(B5,  tmp32) ;

    /*AE_MULAP24X2(B6, p02, p2);*/ //r[6]
    tmp_q0 = AE_MUL32_LL(p02, p2);
    tmp_q1 = AE_MUL32_HH(p02, p2);
    tmp32 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16I(AE_MOVINT16X4_FROMINT64(tmp_q1), AE_MOVINT16X4_FROMINT64(tmp_q0), 3));
    B6 = AE_ADD32(B6,  tmp32) ;

    /*r2 = AE_MULP24X2(p2, p3); *///x2*x3
    tmp_q0 = AE_MUL32_LL(p2, p3);
    tmp_q1 = AE_MUL32_HH(p2, p3);
    r2 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16I(AE_MOVINT16X4_FROMINT64(tmp_q1), AE_MOVINT16X4_FROMINT64(tmp_q0), 3));

    B7 = r2; B8 = r2;
    /*AE_MULAP24X2(B7, p0, p1); */
    tmp_q0 = AE_MUL32_LL(p0, p1);
    tmp_q1 = AE_MUL32_HH(p0, p1);
    tmp32 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16I(AE_MOVINT16X4_FROMINT64(tmp_q1), AE_MOVINT16X4_FROMINT64(tmp_q0), 3));
    B7 = AE_ADD32(B7,  tmp32) ;

    /*AE_MULSP24X2(B8, p0, p1); */
    tmp_q0 = AE_MUL32_LL(p0, p1);
    tmp_q1 = AE_MUL32_HH(p0, p1);
    tmp32 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16I(AE_MOVINT16X4_FROMINT64(tmp_q1), AE_MOVINT16X4_FROMINT64(tmp_q0), 3));
    B8 = AE_SUB32(B8,  tmp32) ;
    ...
    /*r0 = AE_MULP24X2(p0, p0);*/ // x0*x0
    tmp_q0 = AE_MUL32_LL(p0, p0);
    tmp_q1 = AE_MUL32_HH(p0, p0);
    r0 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16I(AE_MOVINT16X4_FROMINT64(tmp_q1), AE_MOVINT16X4_FROMINT64(tmp_q0), 3));
  }
  if (L&1)
  {

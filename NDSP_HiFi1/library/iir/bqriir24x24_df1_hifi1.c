                ...
                const int32_t *                x, int N )
{
  ...
  ae_int32x2 tmp_stx, tmp_p0, tmp_cfa2a1, tmp_t;
  ae_int32x2 t0, t1; 
  ae_f24x2   p0;
  ae_f64     q0, q1;
  ae_int64   u0, u1;
  ...
  for ( m=0; m<M-1; m++ )
  {
    ...
    ae_int32x2 tmp_cfb2b1 = AE_SLAI32S(cf_b2b1,1); 
    ...
    { 
      ...
      tmp_stx = st_x;
      tmp_p0 = p0;
      q1 = AE_MUL32_LH(tmp_cfb2b1,tmp_p0); 
      AE_MULA32_LH(q1,tmp_stx,tmp_cfb2b1);
      q0 = AE_MUL32_HH(tmp_stx,tmp_cfb2b1);
      AE_MULA32_LL(q0,tmp_stx,tmp_cfb2b1);  
    
      // q0 += g*x[n]*b0; q1 += g*x[n+1]*b0
      // Q17.46 <- Q17.46 + [ Q23*Q22 + 1 ]
      tmp_t = AE_SLAI32S(cf_b0, 1);
      AE_MULA32_LH(q1, tmp_t, tmp_p0);
      AE_MULA32_LH(q1, tmp_p0, tmp_t);
      AE_MULA32_HH(q0, tmp_p0, tmp_t);
      AE_MULA32_HL(q0, tmp_p0, tmp_t);
      
      // q0 -= y[n-2]*a2 + y[n-1]*a1;
      // Q17.46 <- Q17.46 + [ Q23*Q22 + 1 ] + [ Q23*Q22 + 1 ]
      tmp_cfa2a1 = cf_a2a1;
      tmp_t = AE_SLAI32S(st_y, 1);
      AE_MULS32_HH(q0, tmp_t, tmp_cfa2a1); 
      AE_MULS32_LL(q0, tmp_t, tmp_cfa2a1); 
      ...
      // Q17.46 <- Q17.46 + [ Q23*Q22 + 1 ] + [ Q23*Q22 + 1 ]
      tmp_t = AE_SLAI32S(st_y, 1);
      AE_MULS32_HH(q1, tmp_t, tmp_cfa2a1); 
      AE_MULS32_LL(q1, tmp_t, tmp_cfa2a1); 
  ...
  for ( n=0; n<N; n+=2 )
  {
    ...
    tmp_stx = st_x;
    tmp_p0 = p0;
    tmp_t = AE_SLAI32S(cf_b2b1,1); 
    q1 = AE_MUL32_LH(tmp_t,tmp_p0); 
    AE_MULA32_LH(q1,tmp_stx,tmp_t);
    q0 = AE_MUL32_HH(tmp_stx,tmp_t);
    AE_MULA32_LL(q0,tmp_stx,tmp_t);        

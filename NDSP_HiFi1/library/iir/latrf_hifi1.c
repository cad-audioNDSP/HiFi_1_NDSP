...
DISCARD_FUN(latr32x16_handle_t, latrf_init, (void * objmem, int M, const float32_t * restrict k, float32_t scale))
DISCARD_FUN(void, latrf_process, (latrf_handle_t _latr, float32_t * restrict r, const float32_t* x, int N))

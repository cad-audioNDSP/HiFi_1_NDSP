...
#define IFFT_BUTTERFLY_S0(_T,_step,_X,twd_step) \
      {                                         \
        ...
        vA2 = AE_ADDSUB32S_HL_LH(vB2, vB3);           \
        ...
        vA3=AE_SRAI32(vA3,8);                   \
        vF1 = (vB0);     \
        vF1=AE_SLAI32S(vF1,8);                   \
        AE_S32X2_##_T##P(vF1, p_x0, _step);  \
        vB0 = AE_ADD32S(vA0, vA2);              \
        vF2 = (vB2);     \
        vF2=AE_SLAI32S(vF2,8);                   \
        AE_S32X2_##_T##P(vF2, p_x3, _step);  \
        vB2 = AE_SUB32S(vA0, vA2);              \
        vF1 = (vB1);     \
        vF1=AE_SLAI32S(vF1,8);                   \
        AE_S32X2_##_T##P(vF1, p_x1, _step);  \
        vB1 = AE_ADD32S(vA1, vA3);              \
        vF2 = (vB3);     \
        vF2=AE_SLAI32S(vF2,8);                   \
        AE_S32X2_##_T##P(vF2, p_x2, _step);  \
...
#define IFFT_BUTTERFLY_S1(_T,_step,_X,twd_step)\
      {                                        \
        ...
        vA0 = AE_L32X2_##_T(p_x0, _step);   \
        vA3 = AE_SUBADD32S_HL_LH(vB2, vB3);          \
        vMX = AE_MAX32(vMX, AE_ABS32S(vC0));          \
        vF1 = (vA2);    \
        ...
        AE_S32X2_##_T##P(vF2, p_x3, _step); \
        vB2 = AE_SUB32S(vA0, vA2);             \
        vMX = AE_MAX32(vMX, AE_ABS32S(vC2));          \
        vF1 = (vC1);    \
        vF1 = AE_SLAI32S(vF1, 8);         \
        AE_S32X2_##_T##P(vF1, p_x1, _step); \
        vB1 = AE_ADD32S(vA1, vA3);             \
        vMX = AE_MAX32(vMX, AE_ABS32S(vC1));          \
        vF2 = (vC3);    \
        vF2 = AE_SLAI32S(vF2, 8);         \
        AE_S32X2_##_T##P(vF2, p_x2, _step); \
        vB3 = AE_SUB32S(vA1, vA3);             \
        vMX = AE_MAX32(vMX, AE_ABS32S(vC3));          \
      }
...
#define IFFT_BUTTERFLY_S3_0(_T,_step,_X,twd_step)\
      {                                        \
        ...
        vF1 = (vC0);    \
        vF1 = AE_SLAI32S(vF1, 6);         \
        AE_S32X2_##_T##P(vF1, p_x0, _step); \
        vB2 = AE_SUB32S(vA0, vA2);             \
        vF2 = (vC2);    \
        vF2 = AE_SLAI32S(vF2, 6);         \
        AE_S32X2_##_T##P(vF2, p_x3, _step); \
        vB1 = AE_ADD32S(vA1, vA3);             \
        vF1 = (vC1);    \
        vF1 = AE_SLAI32S(vF1, 6);         \
...
#define IFFT_BUTTERFLY_R4(idx)         \
    ...
    vA1 = AE_SUBADD32S_HL_LH(vB2, vB3);      \
...
static int ifft_cplx_24x24_core_s0(int32_t *y, int32_t *x, const tFftDescr* pDescr)
{
  ...
  { // first iteration for pre-scaling
    ...
    vA0 = AE_L32X2_I(p_x0, 0);vA0=AE_SRAI32(vA0,8);
    vA1 = AE_L32X2_I(p_x1, 0);vA1=AE_SRAI32(vA1,8);
    vA2 = AE_L32X2_I(p_x2, 0);vA2=AE_SRAI32(vA2,8);
    vA3 = AE_L32X2_I(p_x3, 0);vA3=AE_SRAI32(vA3,8);

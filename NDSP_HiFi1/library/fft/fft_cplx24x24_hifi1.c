...
static inline ae_f32x2 AE_MAXABS32S_HIFI1(ae_f32x2 x, ae_f32x2 y)
{
  x = AE_MAX32(x,AE_ABS32S(y));
  return x;
}

#define FFT_BUTTERFLY_S0(_T,_step,_X,twd_step)  \
      {                                         \
        vT2 = AE_L32X2_I(p_twd, 8);             \
        /*vB3 = AE_SEL32_LH(vB3, vB3);*/            \
        vA1 = AE_SUB32S(vB0, vB1);              \
        vT3 = AE_L32X2_I(p_twd, 16);            \
        vB0 = AE_ADD32S(vB0, vB1);              \
        AE_L32X2_##_X(vT1, p_twd, twd_step);    \
        vA2 = AE_SUBADD32S_HL_LH(vB2, vB3);           \
        vA0 = AE_L32X2_##_T(p_x0, _step);    \
		vA0 = AE_SRAI32(vA0, 8);                \
        vA3 = AE_ADDSUB32S_HL_LH(vB2, vB3);           \
        vF1 = (vA1);     \
        vB1 = AE_MULFC24RA_HIFI1(vF1, vT2);           \
        vA1 = AE_L32X2_##_T(p_x1, _step);    \
		vA1 = AE_SRAI32(vA1, 8);                \
        vF1 = (vA2);     \
        vB2 = AE_MULFC24RA_HIFI1(vF1, vT3);           \
        vA2 = AE_L32X2_##_T(p_x2, _step);    \
		vA2 = AE_SRAI32(vA2, 8);                \
        vF1 = (vA3);     \
        vB3 = AE_MULFC24RA_HIFI1(vF1, vT1);           \
        vA3 = AE_L32X2_##_T(p_x3, _step);    \
		vA3 = AE_SRAI32(vA3, 8);                \
        vF1 = (vB0);     \
        AE_S32X2_##_T##P(AE_SLAI32S(vF1, 8), p_x0, _step);  \
        vB0 = AE_ADD32S(vA0, vA2);              \
        vF2 = (vB2);     \
        AE_S32X2_##_T##P(AE_SLAI32S(vF2, 8), p_x3, _step);  \
        vB2 = AE_SUB32S(vA0, vA2);              \
        vF1 = (vB1);     \
        AE_S32X2_##_T##P(AE_SLAI32S(vF1, 8), p_x1, _step);  \
        vB1 = AE_ADD32S(vA1, vA3);              \
        vF2 =(vB3);     \
        AE_S32X2_##_T##P(AE_SLAI32S(vF2, 8), p_x2, _step);  \
...
#define FFT_BUTTERFLY_S1(_T,_step,_X,twd_step)  \
      {                                         \
        ...
        vA0 = AE_L32X2_##_T(p_x0, _step);    \
        vA3 = AE_ADDSUB32S_HL_LH(vB2, vB3);           \
        vMX = AE_MAXABS32S_HIFI1(vMX, vC0);           \
        vF1 = (vA2);     \
        vC2 = AE_MULFC24RA_HIFI1((vF1), (vT3));           \
        vA2 = AE_L32X2_##_T(p_x2, _step);    \
        vA0 = AE_SRAS32(vA0);                   \
        vF1 = (vA1);     \
        vC1 = AE_MULFC24RA_HIFI1((vF1), (vT2));           \
        vA1 = AE_L32X2_##_T(p_x1, _step);    \
        vA2 = AE_SRAS32(vA2);                   \
        vF1 = (vA3);     \
        vC3 = AE_MULFC24RA_HIFI1((vF1), (vT1));           \
        vA3 = AE_L32X2_##_T(p_x3, _step);    \
        vA1 = AE_SRAS32(vA1);                   \
        vF1 = (vC0);     \
        AE_S32X2_##_T##P(AE_SLAI32S(vF1,8), p_x0, _step);  \
        ...
        AE_S32X2_##_T##P(AE_SLAI32S(vF2,8), p_x3, _step);  \
        vB2 = AE_SUB32S(vA0, vA2);              \
        vMX = AE_MAXABS32S_HIFI1(vMX, vC2);           \
        vF1 = (vC1);     \
        AE_S32X2_##_T##P(AE_SLAI32S(vF1,8), p_x1, _step);  \
        vB1 = AE_ADD32S(vA1, vA3);              \
        vMX = AE_MAXABS32S_HIFI1(vMX, vC1);           \
        vF2 = (vC3);     \
        AE_S32X2_##_T##P(AE_SLAI32S(vF2,8), p_x2, _step);  \
        vB3 = AE_SUB32S(vA1, vA3);              \
        vMX = AE_MAXABS32S_HIFI1(vMX, vC3);           \
      }  
...
#define FFT_BUTTERFLY_S3_0(_T,_step,_X,twd_step)\
      {                                         \
        ...
        AE_L32X2_##_X(vT1, p_twd, twd_step); \
        vA2 = AE_SUBADD32S_HL_LH(vB2, vB3);           \
        vF1 = AE_L32X2_##_T(p_x0, _step);    \
        vA0 = (vF1);                            \
        vA3 = AE_ADDSUB32S_HL_LH(vB2, vB3);           \
        vF1 = (vA1);     \
        vF0 = AE_MULFC24RA_HIFI1((vF1), (vT2));           \
        vC1 = (vF0);                            \
        vF2 = AE_L32X2_##_T(p_x1, _step);    \
        vA1 = (vF2);                            \
        vA0 = AE_SRAI32(vA0, 11);                \
        vF1 = (vA2);     \
        vF0 = AE_MULFC24RA_HIFI1((vF1), (vT3));           \
        vC2 = (vF0);                            \
        vF1 = AE_L32X2_##_T(p_x2, _step);    \
        vA2 = (vF1);                            \
        vA1 = AE_SRAI32(vA1, 11);                \
        vF1 = (vA3);     \
        vF0 = AE_MULFC24RA_HIFI1((vF1), (vT1));           \
        vC3 = (vF0);                            \
        vF2 = AE_L32X2_##_T(p_x3, _step);    \
        vA3 = (vF2);                            \
        ...
        vF1 = (vC0);     \
        AE_S32X2_##_T##P(AE_SLAI32S(vF1,6), p_x0, _step);  \
        vB2 = AE_SUB32S(vA0, vA2);              \
        vF2 = (vC2);     \
        AE_S32X2_##_T##P(AE_SLAI32S(vF2,6), p_x3, _step);  \
        vB1 = AE_ADD32S(vA1, vA3);              \
        vF1 = (vC1);     \
        AE_S32X2_##_T##P(AE_SLAI32S(vF1,6), p_x1, _step);  \
        vB3 = AE_SUB32S(vA1, vA3);              \
        vF2 = (vC3);     \
        AE_S32X2_##_T##P(AE_SLAI32S(vF2,6), p_x2, _step);  \
        vA1 = AE_SUB32S(vB0, vB1);              \
      }
...
#define FFT_BUTTERFLY_R2(idx)          \
    ...
    AE_L32X2_IP(vF2, p_x0, 32);     \
    vA0 = (vF2);                       \
    vB0 = AE_ADD32(vA0, vA1);         \
    vB2 = AE_SUB32(vA0, vA1);         \
    vB1 = AE_ADD32(vA2, vA3);         \
    vB3 = AE_SUB32(vA2, vA3);         \
    vF1 = (vB0);\
    AE_S32X2_X(vF1, p_y0, idx);     \
    vF2 = (vB1);\
    AE_S32X2_X(vF2, p_y1, idx);     \
    vF1 = (vB2);\
    AE_S32X2_X(vF1, p_y2, idx);     \
    vF2 = (vB3);\
    AE_S32X2_X(vF2, p_y3, idx);     \
    }
...
#define FFT_BUTTERFLY_R4(idx)          \
    ...
    AE_L32X2_IP(vF2, p_x0, 32);     \
    vA0 = (vF2);                       \
    vB0 = AE_ADD32(vA0, vA2);         \
    vB2 = AE_SUB32(vA0, vA2);         \
    vB1 = AE_ADD32(vA1, vA3);         \
    vB3 = AE_SUB32(vA1, vA3);         \
    vA0 = AE_ADD32(vB0, vB1);         \
    vA2 = AE_SUB32(vB0, vB1);         \
...
{
  ae_f32x2 * restrict p_x0, * restrict p_x1, * restrict p_x2, * restrict p_x3;
  const ae_f32x2 * restrict p_twd;
  const ae_int16 * restrict p_inc;
  int step_circ;

  ae_int32x2  vA0, vA1, vA2, vA3, vB0, vB1, vB2, vB3;
  ae_f32x2    vF1, vF2, vT1, vT2, vT3;
  ae_f32x2    vT1_1, vT2_1, vT3_1;
  ae_f32x2    vT1_2, vT2_2, vT3_2;
  ae_int16x4  vS;
  int N;
  int stride,scale=0;
  ...
  {
    N=pDescr->N;
    p_twd = (const ae_f32x2 *)(pDescr->twd);
  ...
  if (stride == 8)
  {
    ...
    vT2_1 = AE_L32X2_I(p_twd, 8);
    vT3_1 = AE_L32X2_I(p_twd, 16);
    AE_L32X2_XC(vT1_1, p_twd,step_circ);
	
    vT2_2 = AE_L32X2_I(p_twd, 8);
    vT3_2 = AE_L32X2_I(p_twd, 16);
    AE_L32X2_XC(vT1_2, p_twd,step_circ);
    do 
    {
...
static int fft_cplx_24x24_core_s1(int32_t *y, int32_t *x, const tFftDescr* pDescr, int exp)
{
  ...
  if (exp>0)
  {
    ...
    AE_L32X2_IP(vF1, p_x0, 8);
    AE_L32X2_IP(vF2, p_x0, 8);
    vA0 = vF1;
    vA1 = vF2;
    ...
    for (k=0; k<(N>>1)-1; ++k)
    {
      ...
      vF1 = (vB0);
      AE_S32X2_I(vF1, p_x0, -32);

      vF2 = (vB1);
      AE_S32X2_I(vF2, p_x0, -24);
    }
    vB0 = AE_SRAS32(vA0);
    vB1 = AE_SRAS32(vA1);
    vF1 = (vB0);
    AE_S32X2_I(vF1, p_x0, -16);
    vF2 = (vB1);
    AE_S32X2_I(vF2, p_x0, -8);
    scale += exp;
  }

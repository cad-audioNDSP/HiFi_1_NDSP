    ...
    f24 * restrict y, const f24 * x, int N, int D )
{
    ...
    ae_int32x2 * pWr;
    ae_valign ay,aD;
    ae_int32x2 X01,X23,X45,X67,H01;
    int n,m;
    NASSERT(h);
    NASSERT(d);
    NASSERT(p);
    ...
    for (n=0; n<N; n+=4)
    {
        ...
        for (m=0; m<M; m+=2)
        {
            ...
            AE_MULAF32R_HH(q0,X01,H01);
            AE_MULAF32R_LL(q0,X01,H01);

            /*AE_MULAAFD24_HH_LL(q1,X23,H01); */
            AE_MULAF32R_HH(q1,X23,H01);
            AE_MULAF32R_LL(q1,X23,H01);

            /* AE_MULAAFD24_HH_LL(q2,X45,H01); */
            AE_MULAF32R_HH(q2,X45,H01);
            AE_MULAF32R_LL(q2,X45,H01);

            /*AE_MULAAFD24_HH_LL(q3,X67,H01); */
            AE_MULAF32R_HH(q3,X67,H01);
            AE_MULAF32R_LL(q3,X67,H01);
            X67=X45;
            X45=X23;
            X23=X01;
            AE_LA32X2_RIC(X01,aD,pD);
        ...
        AE_SA32X2_IP( AE_SLAI32S(AE_ROUND24X2F48SASYM( q0, q1 ),8), ay, pY );
        AE_SA32X2_IP( AE_SLAI32S(AE_ROUND24X2F48SASYM( q2, q3 ),8), ay, pY );
    }
    AE_SA64POS_FP(ay,pY);
    return (int32_t*)pWr;
}
    ...
    f24 * restrict y, const f24 * x, int N, int D )
{
    ...
    const ae_int32x2* pD4;
    const ae_int32x2* pD5;
    const ae_int32x2* pD6;
    const ae_int32x2* pD7;
    const ae_int32x2* pH;
    ae_int32x2 * pWr;
    ae_valign ay;
    ae_int32x2 X01,X23,X45,X67,H01;
    ...
    for (n=0; n<N; n+=8)
    {
        ...
        AE_LA32X2NEG_PC(ad0,pD1);
        pD3=pD1; AE_L32_XC(t,castxcc(ae_int32, pD3),2*D*sizeof(int32_t)); 
        pD5=pD3; AE_L32_XC(t,castxcc(ae_int32, pD5),2*D*sizeof(int32_t)); 
        pD7=pD5; AE_L32_XC(t,castxcc(ae_int32, pD7),2*D*sizeof(int32_t)); 
        pD2=pD0; AE_L32_XC(t,castxcc(ae_int32, pD2),2*D*sizeof(int32_t)); 
        pD4=pD2; AE_L32_XC(t,castxcc(ae_int32, pD4),2*D*sizeof(int32_t)); 
        pD6=pD4; AE_L32_XC(t,castxcc(ae_int32, pD6),2*D*sizeof(int32_t)); 

        AE_LA32X2NEG_PC(ad0,pD0);
        AE_LA32X2NEG_PC(ad2,pD2);
        AE_LA32X2NEG_PC(ad4,pD4);
        AE_LA32X2NEG_PC(ad6,pD6);
        for (m=0; m<M; m+=2)
        {
            AE_L32X2_IP(H01,pH,2*sizeof(int32_t));
            AE_LA32X2_RIC(X01,ad0,pD0); 
            AE_L32X2_RIC (X23,pD1);
            AE_LA32X2_RIC(X45,ad2,pD2); 
            AE_L32X2_RIC(X67,pD3);
            ...
            AE_LA32X2_RIC(X01,ad4,pD4);
            AE_L32X2_RIC(X23,pD5);
            AE_LA32X2_RIC(X45,ad6,pD6);
            AE_L32X2_RIC(X67,pD7);

            /*AE_MULAAFD24_HH_LL(q4,X01,H01); */
            AE_MULAF32R_HH(q4,X01,H01);
            AE_MULAF32R_LL(q4,X01,H01);

            /*AE_MULAAFD24_HH_LL(q5,X23,H01); */
            AE_MULAF32R_HH(q5,X23,H01);
            AE_MULAF32R_LL(q5,X23,H01);

            /*AE_MULAAFD24_HH_LL(q6,X45,H01);*/
            AE_MULAF32R_HH(q6,X45,H01);
            AE_MULAF32R_LL(q6,X45,H01);

            /*AE_MULAAFD24_HH_LL(q7,X67,H01);*/
            AE_MULAF32R_HH(q7,X67,H01);
            AE_MULAF32R_LL(q7,X67,H01);
        }

        ae_int32x2 res1 = AE_MOVINT32X2_FROMINT24X2(AE_ROUND24X2F48SASYM(q0,q1));
        ae_int32x2 res2 = AE_MOVINT32X2_FROMINT24X2(AE_ROUND24X2F48SASYM(q2,q3));
        ae_int32x2 res3 = AE_MOVINT32X2_FROMINT24X2(AE_ROUND24X2F48SASYM(q4,q5));
        ae_int32x2 res4 = AE_MOVINT32X2_FROMINT24X2(AE_ROUND24X2F48SASYM(q6,q7));

        res1 = AE_SLAI32(res1,8);
        res2 = AE_SLAI32(res2,8);
        res3 = AE_SLAI32(res3,8);
        res4 = AE_SLAI32(res4,8);

        AE_SA32X2_IP(res1,store,pY);
        AE_SA32X2_IP(res2,store,pY);
        AE_SA32X2_IP(res3,store,pY);
        AE_SA32X2_IP(res4,store,pY);
        
    }
    AE_SA64POS_FP(store,pY);
    return (int32_t*)pWr;
}
    ...
    f24 * restrict y, const f24 * x, int N, int D )
{
    ...
    ae_int32x2 * pWr;
    ae_valign ay,aD;
    ae_int32x2 X01,X23,X89,Xab,H01,H23;
    int m,n;
    NASSERT(h);
    NASSERT(d);
    NASSERT(p);
    ...
    for (n=0; n<N; n+=2)
    {
        ...
        q0=q1=AE_ZERO();
        pD=(ae_int32x2*)pWr;
        AE_L32_XC(t, (ae_int32 *)pD, 4 * sizeof(int32_t));
        pH=(const ae_int32x2*)h;
        AE_L32X2_IP(t,pX,2*sizeof(int32_t));  AE_S32X2_XC(t,pWr,2*sizeof(int32_t));
        AE_L32X2_IP(t,pX,2*sizeof(int32_t));  AE_S32X2_XC(t,pWr,2*sizeof(int32_t));
        AE_L32X2_IP(t,pX,2*sizeof(int32_t));  AE_S32X2_XC(t,pWr,2*sizeof(int32_t));
        ...
        for (m=0; m<(M & ~3); m+=4)
        {
            ...
            AE_MULAF32R_HH(q0,X89,H23);
            AE_MULAF32R_LL(q0,X89,H23);

            /*AE_MULAAFD24_HH_LL(q1,Xab,H23); */
            AE_MULAF32R_HH(q1,Xab,H23);
            AE_MULAF32R_LL(q1,Xab,H23);
        ...
        AE_SA32X2_IP( AE_SLAI32(AE_ROUND24X2F48SASYM( q0, q1 ),8), ay, pY );
    }
    AE_SA64POS_FP(ay,pY);
    return (int32_t*)pWr;
}
    ...
    f24 * restrict y, const f24 * x, int N, int D )
{
    ...
    for (n=0; n<N; n+=4)
    {
        ...
        pD1=pD0; AE_L32_XC(t,(ae_int32 *)pD1,D*sizeof(int32_t)); 
        pD2=pD1; AE_L32_XC(t,(ae_int32 *)pD2,D*sizeof(int32_t)); 
        pD3=pD2; AE_L32_XC(t,(ae_int32 *)pD3,D*sizeof(int32_t)); 
        ...
        for (m=0; m<M; m+=2)
        {
            ...
            /* AE_MULAAFD24_HH_LL(q0,X01,H01); */
            AE_MULA32_HH(q0,X01,H01);
            AE_MULA32_LL(q0,X01,H01);

            /*AE_MULAAFD24_HH_LL(q1,X23,H01); */
            AE_MULA32_HH(q1,X23,H01);
            AE_MULA32_LL(q1,X23,H01);

            /* AE_MULAAFD24_HH_LL(q2,X45,H01); */
            AE_MULA32_HH(q2,X45,H01);
            AE_MULA32_LL(q2,X45,H01);

            /*AE_MULAAFD24_HH_LL(q3,X67,H01); */
            AE_MULA32_HH(q3,X67,H01);
            AE_MULA32_LL(q3,X67,H01);
        }
        q0 = AE_SLAI64S(q0,1);
        q1 = AE_SLAI64S(q1,1);
        q2 = AE_SLAI64S(q2,1);

...
/*-------------------------------------------------*/
  ...
  for ( m=0; m<M; m+=8 )
  {
    ...
    y0 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16_6521(AE_MOVINT16X4_FROMINT64(B0),AE_MOVINT16X4_FROMINT64(B1)));
    y1 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16_6521(AE_MOVINT16X4_FROMINT64(B2),AE_MOVINT16X4_FROMINT64(B3)));
    y2 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16_6521(AE_MOVINT16X4_FROMINT64(B4),AE_MOVINT16X4_FROMINT64(B5)));
    y3 = AE_MOVINT32X2_FROMINT16X4(AE_SEL16_6521(AE_MOVINT16X4_FROMINT64(B6),AE_MOVINT16X4_FROMINT64(B7)));
#else
    y0 = AE_TRUNCA32X2F64S(B0,B1,16);
    y1 = AE_TRUNCA32X2F64S(B2,B3,16);
    y2 = AE_TRUNCA32X2F64S(B4,B5,16);
    ...
    y0 = AE_SEL32_LL(AE_MOVINT32X2_FROMINT64(B0),AE_MOVINT32X2_FROMINT64(B1));
    y1 = AE_SEL32_LL(AE_MOVINT32X2_FROMINT64(B2),AE_MOVINT32X2_FROMINT64(B3));
    y2 = AE_SEL32_LL(AE_MOVINT32X2_FROMINT64(B4),AE_MOVINT32X2_FROMINT64(B5));
    y3 = AE_SEL32_LL(AE_MOVINT32X2_FROMINT64(B6),AE_MOVINT32X2_FROMINT64(B7));

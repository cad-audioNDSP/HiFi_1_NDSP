                 ...
                 int N, int M )
{
    ...
    s_ptr = x_buf + M-1 + N + 3;
    y_buf = (ae_f32*)ALIGNED_ADDR( s_ptr, 8 );
    s_ptr = y_buf + M + 3;
  ...
  #pragma concurrent
      ...
      AE_S32_L_I( AE_ZERO32(), (      ae_f32 *)D, 0*sizeof(int32_t) );
      AE_S32_L_I( AE_ZERO32(), (      ae_f32 *)D, 1*sizeof(int32_t) );
      AE_S32_L_I( AE_ZERO32(), (      ae_f32 *)D, 2*sizeof(int32_t) );
      AE_S32_L_I( AE_ZERO32(), (      ae_f32 *)D, 3*sizeof(int32_t) );
      //----------------------------------------------------------------------------
    ...
    AE_S32_L_I( AE_ZERO32(), (      ae_f32 *)D, 2*sizeof(int32_t) );
    AE_S32_L_I( AE_ZERO32(), (      ae_f32 *)D, 3*sizeof(int32_t) );
    raw_corr24x24(r, (f24 *)x_buf, (f24 *)y_buf,N,(M+1)&~1);
} /* fir_convola24x24() */

               ...
               int N, int M )
{
  ...
  //
    ...
    for ( n=0; n<N; n+=4 )
    {
        ...
        d0 = AE_MOVINT32X2_FROMF24X2(AE_ROUND24X2F48SASYM( a0, a1 )); 
        d0 = AE_SLAI32(d0, 8);
        AE_S32X2_IP( d0, pR, sizeof(int32_t)*2);

        d0 = AE_MOVINT32X2_FROMF24X2(AE_ROUND24X2F48SASYM( a2, a3 )); 
        d0 = AE_SLAI32(d0, 8);
        AE_S32X2_IP( d0, pR, sizeof(int32_t)*2);
    }
} // fir_xcorr24x24()
